package day18_jdbc_mvc.connUtil;
...
public class ConnectionHelper {
	...
	public static Connection getConnection(String dsn) {
		...
		try {
			if(dsn.equals("mysql")) {
				Class.forName("org.mysql.jdbc.Driver"); // exception
				...
				conn = DriverManager.getConnection("jdbc:oracle:thin:@hostname:port:orcl", "joo", "oracle");
	...
	public static void menu() {
		...
		System.out.println("\t 4. 조건에 의한 검색");
